...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Update the positon of the bullets and get rid of old ones."""
    ...
    # If so getrid of the bullet and the alien.
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship,
        aliens, bullets):
    """Respond to bulet-alien collisions."""
...
#def update_aleins(aliens):
    """Update the postions of all the aliens in the fleet."""
 #   aliens.update()


def check_fleet_edges(ai_settings, aliens):
    """Respond appropirately if any aliens have reached an edge"""
...
def check_aliens_bottom(ai_settings, stats, screen, sb, ship, aliens, bullets):
    """Check if any aliens have reached the bottom of the ship"""
...
def check_high_score(stats, sb):
    """Check to see it there is a new high score."""
